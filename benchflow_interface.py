#!/usr/bin/env python3
# BenchFlow Interface for ClassEval
# This file is a template for integrating ClassEval with BenchFlow
...
class BenchflowInterface:
    ...
    def load_benchmark(self) -> bool:
        ...
        try:
            ...
            print(f"Loading ClassEval benchmark...")
            return True
    ...
    def get_benchmark_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "version": "1.0.0",
            "category": "code",
            "github": "https://github.com/amazon-science/class-level-code-generation",
            "paper": "",
            "website": ""
        }
