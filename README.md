...
<img src="images/classeval_example.png" alt="other benchmark example" style="zoom: 5%;" />

<img src="images/other_benchmark_example.png" alt="other benchmark example" style="zoom: 8%;" />

The comparison of test case examples from the ClassEval, HumanEval, and MBPP datasets is depicted in the following figure:

<img src="images/test_example.png" alt="test example" style="zoom: 28%;" />
...
<img src="images/C_pass1_bar.png" alt="C_pass1_bar" style="zoom: 29%;" />

The following table presents the class-level and method-level Pass@k
with nucleus sampling on ClassEval:

<img src="images/pass_at_k.png" alt="pass@k" style="zoom: 50%;" />
...
<img src="images/C_pass5.png" alt="pass@k" style="zoom: 45%;" />

<img src="images/M_pass5.png" alt="pass@k" style="zoom: 45%;" />
